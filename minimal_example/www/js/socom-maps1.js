                        ...
                        var marker = new L.Marker(coordinates,
                            {
                                ...
                                icon: new L.DivIcon({
                                    html: "<div class='pin' style='background: #219710 nickname='" + operator.nickname + "'></div>",
                    ...
                    if ($scope.myLocation) {
                        ...
                        $scope.myLocation = new L.Marker(
                            new L.LatLng(pos.coords.latitude, pos.coords.longitude),
                            {
                                ...
                                icon: new L.DivIcon({
                                    html: "<div class='pin pin-orange' style='background: #FF5D00' nickname='YOUR_NAME'></div><div class='pulse'></div>",
                                    iconSize: new L.Point(0, 0)
                                })
                            }
                        ).addTo($scope.map.map);
